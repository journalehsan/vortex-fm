                ...
                for tab_command in tab_commands {
                    match tab_command {
                        ...
                        tab::Command::OpenTrash => {
                            ...
                            let mut command = process::Command::new("vortex-fm");
                            command.arg("--trash");
                            match spawn_detached(&mut command) {
                                Ok(()) => {}
                                Err(err) => {
                                    log::warn!("failed to run vortex-fm --trash: {}", err)
                                }
                            }
                        }
                    ...
                    OutputEvent::Created(output_info_opt) => {
                        ...
                        return Task::batch([
                            ...
                            get_layer_surface(SctkLayerSurfaceSettings {
                                ...
                                namespace: "vortex-files-applet".into(),
                                size: Some((None, None)),
                                margin: IcedMargin {
                                    top: 0,
                                    bottom: 0,
